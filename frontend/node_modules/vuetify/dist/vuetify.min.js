/*!
* Vuetify v3.0.0-next-20220422.0
...
const a=At(e,"modelValue"),n=xn(),o=t.ref([]),r=t.ref(!0),i=t.computed((()=>k(""===a.value?null:a.value).length>0)),s=t.computed((()=>!!(e.disabled||null!=n&&n.isDisabled.value))),u=t.computed((()=>!!(e.readonly||null!=n&&n.isReadonly.value))),c=t.computed((()=>e.errorMessages.length?k(e.errorMessages):o.value)),d=t.computed((()=>!e.error&&!c.value.length&&(!r.value||null))),v=t.ref(!1),p=t.computed((()=>({[`${l}--error`]:!1===d.value,[`${l}--dirty`]:i.value,[`${l}--disabled`]:s.value,[`${l}--readonly`]:u.value}))),f=t.computed((()=>{var t
...
return t.createVNode("form",{ref:i,class:"v-form",novalidate:!0,onReset:s,onSubmit:u},[null==(e=a.default)?void 0:e.call(a,r)])})),Bt(r,i)}}),Zr=fe({name:"VContainer",props:{fluid:{type:Boolean,default:!1},...ht()},setup(e,l){let{slots:a}=l
...
return ys({components:us,directives:gs,...e})},e.directives=gs,e.provideRtl=ot,e.useDisplay=ho,e.useLayout=Ze,e.useRtl=rt,e.useTheme=We,e.version="3.0.0-next-20220422.0",Object.defineProperty(e,"__esModule",{value:!0})}))
